...
static coap_response_t response_handler(coap_session_t *session,const coap_pdu_t *sent,const coap_pdu_t *received,const coap_mid_t id)
{
...
int coapDtls(void)
{
    ...
    if (resolve_address("192.168.3.31", "5684", &server_address) < 0)
    {
