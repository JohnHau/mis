...
void menu3_MsgHandlle(uint8_t key)
{
    ...
    switch(key)
    {
        ...
        case KEY_DOWN_PRESSED:
            ...
            {
                menu[3].parameter --;  
                if(menu[3].parameter == -1) menu[3].parameter = 1;
            }
            else
            {
                if(focus == 4)
...
void menu5_MsgHandlle(uint8_t key)
{
    ...
    switch(key)
    {
        case KEY_UP_PRESSED:
            ...
            {
                menu[5].parameter ++;  
                if(menu[5].parameter == 2) menu[5].parameter = 0;
            }
            else
            {
                if(focus ==6)
        ...
        case KEY_DOWN_PRESSED:
            ...
            {
                menu[5].parameter --;  
                if(menu[5].parameter == -1) menu[5].parameter = 1;
            }
            else
            {
                if(focus ==6)
...
void menu6_MsgHandlle(uint8_t key)
{
    ...
    switch(key)
    {
        case KEY_UP_PRESSED:
            ...
            {
                menu[6].parameter ++;  
                if(menu[6].parameter == 2) menu[6].parameter = 0;
            }
            else
            {
                if(focus == 7)
        ...
        case KEY_DOWN_PRESSED:
            ...
            {
                menu[6].parameter --;  
                if(menu[6].parameter == -1) menu[6].parameter = 1;
            }
            else
            {
                if(focus == 7)
